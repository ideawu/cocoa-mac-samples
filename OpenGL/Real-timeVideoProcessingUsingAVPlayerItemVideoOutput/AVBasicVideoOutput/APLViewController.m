...
- (void)downloadVideo{
	NSString *url = @"http://localhost/tmp/a00.mov";
...
- (void)playVideoData:(NSData *)data{
	seq = (seq + 1) % 99;
	NSString *filename = [NSString stringWithFormat:@"%@/download_%03d.mov", NSTemporaryDirectory(), seq];
